    ...
    <nav>
        <div class="flex_container">
            <div class="flex_item" id="0">
                <img class="image" src="/images/ash.jpg" alt="">
            </div>
            <div class="flex_item" id="1">
                <img class="image" src="/images/Binr.jpg" alt="">
            </div>
            <div class="flex_item" id="2">
                <img class="image" src="/images/chestnut.jpg" alt="">
            </div>
            <div class="flex_item" id="3">
                <img class="image" src="/images/forester.jpg" alt="">
            </div>
            <div class="flex_item" id="4">
                <img class="image" src="/images/tanzania.jpg" alt="">
            </div>
        </div>
    </nav>
